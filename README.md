...
- Innen temp sinkt im Zyklus (diff < -0.1°C) → duty - step, step auf 2 setzen
- Innen temp steigt oder gleich (diff >= -0.1°C) für 2 Zyklen → duty + step, step auf 4 setzen, step verdoppeln (4→8→16→32, max 32%)
- Startwert Step: 4%
